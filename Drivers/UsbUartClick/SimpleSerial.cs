...
namespace MBN.Modules
{
    ...
    public partial class USBUARTClick
    {
        /// <summary>
        ...
        internal class SimpleSerial : SerialPort
        {
            ...
            internal SimpleSerial(string portName, int baudRate, Handshake handshake = Handshake.None)
                ...
                bool includeDelimiterInOutput = false)
            {
                ...
                else
                {
                    ...
                    prelimOutput[prelimOutput.Length - 1] = string.Empty;
                        // remove the remainder string from prelimOutput to avoid redundancy
                }
